...
; calculate ra and dec in radians

pro wcstpv_xy2rd, xin, yin, wcs, ra, dec, degree=degree
    ...
    ;Add the distortion transformation using the PV coefficients
    ; xi, eta, xip, etap are in degrees
    wcstpvcor,xi, eta, wcs, xip, etap
    ...
    ; Make sure the RAs are positive
    bd = where(ra lt 0.0,nbd)
    if nbd gt 0 then ra[bd]+=2*!dpi
