...
pro photred_wcs,nmulti=nmulti,redo=redo,stp=stp,testing=testing,std=std
...
if wcsrefname ne 'USNO-B1' and wcsrefname ne '2MASS-PSC' and wcsrefname ne 'UCAC4' and $
   wcsrefname ne 'GAIA/GAIA' and wcsrefname ne 'GAIADR2' then wcsrefname='GAIADR2'
...
if ncmd gt 0 then begin
  ...
  PBS_DAEMON,cmd,cmddir,nmulti=nmulti,prefix='wfit',hyperthread=hyperthread,$
