pro stdred_summary,stp=stp

;+
;
; STDRED_SUMMARY
;
; This gives a summary of the progress of the STDRED stages
;
; INPUTS:
;  none
;
...
;
stages = ['RENAME','SPLIT','WCS','APERPHOT','DAOGROW','ASTROM',$
          'MATCHCAT','COMBINECAT','FITDATA']
...
CD,current=curdir
print,''
print,'STDRED SUMMARY for ',curdir
print,''
print,'--------------------------------------------'
